   ...
   init: function() {
    ...
    createPicker: function() {
      ...
      if (this.settings.width < 240) {
       ...
       var html=this.$picker;

        $('.emoji-popup-'+id[1]).popover({html:true, content: html, placement: "top"});
        $('.emoji-popup-'+id[1]).popover('show');
        this.active = true;
    ...
    clickOutside: function(e) {
      ...
      if (this.active) {
        var id=this.$el.attr('id').split('-');      
        $('.emoji-popup-'+id[1]).popover('dispose');
      }
    },
